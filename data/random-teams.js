...
/** @type {typeof import('./../battle-engine/dex').Dex} */
const Dex = require(/** @type {any} */ ('./../battle-engine/dex')).Dex;
/** @type {typeof import('./../battle-engine/prng').PRNG} */
const PRNG = require(/** @type {any} */ ('./../battle-engine/prng')).PRNG;
